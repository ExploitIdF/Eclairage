...
:download:`table de 1200 lignes (Suivre le lien)<https://exploitidf.github.io/Eclairage/_static/table.xls>` 
...
La nature de certains champs est assez bien décrite par les noms des champs, mais pour d'autres champs, il est utile d'apporter les précisions suivantes:
...
La table Sidonie est renseignée à plus de 80%, mais ce n'est pas suffisante pour qu'elle puisse servir de référentiel pour la gestion de la maintenance de tous les tunnels. Le champ **'nombre_lampe'** n'est renseigné qu'à 60% environ.

Abdellah BENADJEMIA  (Chef de l'Unité Connaissance du Patrimoine Routier) a prévu de compléter cette table d'ici la fin de l'année 2023, en s'appuyant sur les documents détenus par son unité. A cette occasion la puissance des lampes sera ajoutée à la table.
